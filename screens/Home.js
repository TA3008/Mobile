    ...
    return (
      <TouchableOpacity onPress={closeDrawer} style={styles.animatedBox}>
        ...
        <View style={styles.menuItem}>
          ...
          <Text style={styles.menuText} onPress={handleCartPress}>Cart</Text>
        </View>
        <View style={styles.menuItem}>
            <Image source={require('../assets/Icons/logout.png')}/>
          <Text style={styles.menuText} onPress={handleLoginPress}>Logout</Text>
        </View>
    ...
    <View style={styles.container}>
      ...
      <MenuDrawer
        ...
        <View style={styles.searchContainer}>
          ...
          />
          <TouchableOpacity style={styles.menuButton} onPress={handleSearchPress}> 
        ...
        <ScrollView>
            ...
            <Text style={styles.title}>Các Sản Phẩm Mới Nhất</Text>
            <View style={styles.collection}>
